(function () {
  ...
  function syncDock() {
    ...
    reserveDock.href = bookHref();
    reserveDock.textContent = isPt() ? "Abrir o Airbnb para reservar" : "Open Airbnb to book";
  ...
  function renderDock() {
    ...
    dock.hidden = false;
    dock.textContent = isPt() ? "Reserva · " + n + " · a confirmar" : "Book · " + n + " · ask";
  }
